...
const hubs = [
  { name: 'India', city: 'New Delhi', description: 'South Asia manufacturing, logistics, and real estate operations spanning 22 subsidiaries.', tags: ['Tier-1 City', 'ESG Focused'], img: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=800&q=80', alt: 'New Delhi India business hub' },
  { name: 'UAE', city: 'Dubai', description: 'Middle East strategic headquarters overseeing finance, jewellery, and construction verticals.', tags: ['DIFC Registered', 'Tax Efficient'], img: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80', alt: 'Dubai UAE headquarters' },
  { name: 'USA', city: 'New York', description: 'Western markets, capital markets access, and sustainability leadership programs.', tags: ['SEC Compliant', 'ESG Reporting'], img: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=800&q=80', alt: 'New York USA financial center' },
]
              ...
              <div style={{ borderRadius: '16px', overflow: 'hidden', position: 'relative', cursor: 'pointer' }}>
                <div style={{ position: 'relative', aspectRatio: '4/3', overflow: 'hidden' }}>
                  ...
                  <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '1.5rem' }}>
                    ...
                    <h3 style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 800, fontSize: '1.25rem', color: '#ffffff', letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: '0.25rem' }}>{hub.name}</h3>
                    ...
                    <span style={{ fontFamily: 'var(--font-inter)', fontWeight: 600, fontSize: '0.8125rem', color: '#C9922B', display: 'inline-block', marginTop: '0.75rem' }}>View Hub →</span>
                  </div>
                </div>
              </div>
            </FadeIn>
