            ...
            <section className="bg-primary text-white py-16 mt-16 text-center">
                <div className="container">
                    ...
                    <p className="text-xl max-w-2xl mx-auto opacity-90">
                        We operate globally. Reach out to our team for inquiries, partnerships, or support.
                    </p>
                </div>
            </section>
                    ...
                    <div className="contact-grid">
                        ...
                        >
                            <div className="contact-card bg-white shadow-lg rounded-xl p-8 mb-8">
                                <h3 className="text-2xl font-bold text-accent mb-6">Global Headquarters</h3>
                                ...
                                <div className="info-item flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">info@ssingroup.com</p>
                                        <p className="text-gray-600">support@ssingroup.com</p>
                                    </div>
                                </div>

                                <hr className="my-8 border-gray-200" />

                                <a href="https://wa.me/971509876543" target="_blank" rel="noreferrer" className="whatsapp-btn flex items-center justify-center gap-2 w-full bg-[#25D366] text-white py-3 rounded-lg font-semibold hover:bg-[#128C7E] transition-colors">
                        ...
                        >
                            ...
                            {submitted ? (
                                ...
                                <form onSubmit={handleSubmit} className="contact-form">
                                    ...
                                    <button type="submit" className="btn btn-primary w-full flex justify-center items-center gap-2 text-lg py-3 mt-4">
